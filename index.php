                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>个人中心
                                        <div class="page-title-subheading">单击URL访问链接
                                        </div>
                                    </div>
                                </div>
                                <div class="page-title-actions">
                                    <form action="delete.php" method="post">
                                        ...
                                        <input type="text" name="urlDelete" placeholder="请输入删除的URL名称">
                                        <input style="width:70px;height:25px;" type="submit" value="删除URL">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="text-nowrap table-lg mb-0 table table-hover">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM urls WHERE username = '$usernm'";
